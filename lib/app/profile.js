...
module.exports = function (app) {
    ...
    app.get('/u/:username/settings', function (req, res) {
        var out = {};
        req.user.apiKeys().fetch().then(function (keys) {
            out.apikeys = keys.toJSON();
            return req.user.characters().fetch();
        }).then(function (characters) {
            out.characters = characters.toJSON();
        }).finally(function () {
    ...
    app.get('/u/:username/settings/apikey/:keyid/delete', function (req, res) {
        var out = {};
        req.user.apiKeys().query({where: {keyID: req.params.keyid}})
