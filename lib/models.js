...
var chunk_size = 10;
exports.MarketOrders.updateQueue = async.queue(function (row, next) {
    return exports.MarketOrder
    .forge({orderID: row.orderID})
    .createOrUpdate(row)
    .then(function (order) {
        logger.verbose("Queue imported order " +row.orderID);
        next();
    })
    .catch(function (e) {
        next(e);
...
// exports.importQueue.saturated
// exports.importQueue.drain
