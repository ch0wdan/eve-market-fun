...
exports.invTypes = function (opts) {
    var query = exports.db_EVE('invTypes')
        ...
        .select('invGroups.groupName',
                ...
                'attrTechLevel.valueFloat as techLevelFloat',
                'attrTechLevel.valueInt as techLevelInt',
                'invTypes.*')
    ...
    var mungeRows = function (rows) {
        return _.map(rows, function (row) {
            ...
            row.techLevel = row.techLevelFloat || row.techLevelInt || 0;
            delete row.techLevelInt;
            delete row.techLevelFloat;
